...
export default function FavoritesStack(props) {
  return (
    <HomeStack.Navigator initialRouteName="List">
        <HomeStack.Screen name="favList" options={{ headerShown: false }}>
            {(screenProps) => <FavStationsList {...screenProps} allStations={props.allStations} favoriteStations={props.favoriteStations} setfavoriteStations={props.setfavoriteStations} currentDelays={props.currentDelays} />}
        </HomeStack.Screen>
